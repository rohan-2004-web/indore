      ...
      <nav className="container mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="tel:+919372662471" aria-label="Call us" title="Call" className="w-12 h-12 flex items-center justify-center bg-pink-500 hover:bg-pink-600 text-white rounded-full font-semibold text-base transition-all duration-300 ring-1 ring-pink-600 shadow-sm">
              <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white">
            ...
            <a href="https://wa.me/919372662471" target="_blank" rel="noreferrer" aria-label="WhatsApp" title="WhatsApp" className="w-12 h-12 flex items-center justify-center bg-green-600 hover:bg-green-700 text-white rounded-full font-semibold text-base transition-all duration-300 ring-1 ring-green-700 shadow-sm">
              <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white">
