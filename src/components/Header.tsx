      ...
      <nav className="container mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="tel:+919372662471" aria-label="Call us" className="w-12 h-12 flex items-center justify-center bg-pink-500 hover:bg-pink-600 text-white shadow-lg transition-transform transform hover:scale-110">
            ...
            <a href="https://wa.me/919372662471" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-12 h-12 flex items-center justify-center bg-green-600 hover:bg-green-700 text-white shadow-lg transition-transform transform hover:scale-110">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6">
