    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-orange-50 to-pink-200">
        ...
        <main className="pt-20">
          ...
          <section className="relative py-16 bg-gradient-to-br from-pink-100 via-orange-50 to-pink-200 overflow-hidden">
            <div className="absolute inset-0">
              <div className="absolute -top-16 -right-16 w-64 h-64 bg-gradient-to-br from-pink-300/40 to-orange-400/40 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-gradient-to-br from-orange-300/40 to-pink-400/40 rounded-full blur-3xl"></div>
            </div>
          ...
          <section id="locations" className="py-20 relative">
            ...
            <div className="w-full px-4 relative z-10">
              ...
              <div className="w-full space-y-8">
                {/* All Location Cards - Uniform Size */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="group bg-gradient-to-br from-pink-100 to-pink-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-pink-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏢</div>
                      <h3 className="text-2xl font-bold text-pink-800 mb-3">Vijay Nagar</h3>
                      <p className="text-pink-600 font-bold text-lg mb-3">Central Business District</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Premium business district with luxury hotels, shopping centers and corporate offices. Elite escort services available 24/7.</p>
                    </div>
                    <a href="/locations/vijay-nagar" className="w-full inline-block bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book Premium Escorts
                    </a>
                  </div>
                  
                  <div className="group bg-gradient-to-br from-blue-100 to-blue-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-blue-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏘️</div>
                      <h3 className="text-2xl font-bold text-blue-800 mb-3">Saket</h3>
                      <p className="text-blue-600 font-bold text-lg mb-3">Upscale Residential Hub</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Prestigious residential area with modern amenities and gated communities. Discrete home visit services available.</p>
                    </div>
                    <a href="/locations/saket" className="w-full inline-block bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book VIP Escorts
                    </a>
                  </div>
                  
                  <div className="group bg-gradient-to-br from-orange-100 to-orange-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-orange-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">💻</div>
                      <h3 className="text-2xl font-bold text-orange-800 mb-3">Scheme 78</h3>
                      <p className="text-orange-600 font-bold text-lg mb-3">IT Corporate Sector</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Technology hub with corporate offices, business hotels and modern infrastructure. Professional companions available.</p>
                    </div>
                    <a href="/locations/scheme-78" className="w-full inline-block bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book Elite Escorts
                    </a>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="group bg-gradient-to-br from-purple-100 to-purple-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-purple-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🛍️</div>
                      <h3 className="text-2xl font-bold text-purple-800 mb-3">AB Road</h3>
                      <p className="text-purple-600 font-bold text-lg mb-3">Commercial Zone</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Main commercial area with luxury shopping, dining and premium hotels. Elite companions for business meetings.</p>
                    </div>
                    <a href="/locations/ab-road" className="w-full inline-block bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book Premium Escorts
                    </a>
                  </div>
                  
                  <div className="group bg-gradient-to-br from-green-100 to-green-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-green-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🌆</div>
                      <h3 className="text-2xl font-bold text-green-800 mb-3">Palasia</h3>
                      <p className="text-green-600 font-bold text-lg mb-3">City Center</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Heart of Indore with premium facilities, accessibility and upscale venues. Professional escort services 24/7.</p>
                    </div>
                    <a href="/locations/palasia" className="w-full inline-block bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book VIP Escorts
                    </a>
                  </div>
                  
                  <div className="group bg-gradient-to-br from-teal-100 to-teal-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-teal-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏛️</div>
                      <h3 className="text-2xl font-bold text-teal-800 mb-3">Bhawar Kuan</h3>
                      <p className="text-teal-600 font-bold text-lg mb-3">Premium District</p>
                      <p className="text-gray-700 text-base mb-4 leading-relaxed">Prestigious business and residential area with luxury amenities and high-end establishments.</p>
                    </div>
                    <a href="/locations/bhawar-kuan" className="w-full inline-block bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white px-6 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl text-center">
                      📞 Book Elite Escorts
                    </a>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="group bg-gradient-to-br from-indigo-100 to-indigo-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-indigo-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">✈️</div>
                      <h3 className="text-2xl font-bold text-indigo-800 mb-3">Airport Road</h3>
                      <p className="text-indigo-600 font-bold text-lg mb-3">Aviation Zone</p>
                  ...
                  <div className="group bg-gradient-to-br from-rose-100 to-rose-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-rose-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🎯</div>
                      <h3 className="text-2xl font-bold text-rose-800 mb-3">Treasure Island</h3>
                      <p className="text-rose-600 font-bold text-lg mb-3">Entertainment Hub</p>
                  ...
                  <div className="group bg-gradient-to-br from-violet-100 to-violet-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-violet-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏬</div>
                      <h3 className="text-2xl font-bold text-violet-800 mb-3">Rajwada</h3>
                      <p className="text-violet-600 font-bold text-lg mb-3">Historic Area</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="group bg-gradient-to-br from-cyan-100 to-cyan-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-cyan-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏪</div>
                      <h3 className="text-2xl font-bold text-cyan-800 mb-3">MG Road</h3>
                      <p className="text-cyan-600 font-bold text-lg mb-3">Shopping District</p>
                  ...
                  <div className="group bg-gradient-to-br from-emerald-100 to-emerald-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-emerald-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🏥</div>
                      <h3 className="text-2xl font-bold text-emerald-800 mb-3">Bombay Hospital</h3>
                      <p className="text-emerald-600 font-bold text-lg mb-3">Medical District</p>
                  ...
                  <div className="group bg-gradient-to-br from-amber-100 to-amber-200 backdrop-blur-md rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 p-8 border-2 border-amber-300/60 transform hover:-translate-y-3 min-h-[350px] flex flex-col justify-between">
                    <div className="text-center">
                      <div className="text-5xl mb-4">🌳</div>
                      <h3 className="text-2xl font-bold text-amber-800 mb-3">Ring Road</h3>
                      <p className="text-amber-600 font-bold text-lg mb-3">Connectivity Hub</p>
          ...
          <section id="faq" className="py-20 bg-gradient-to-br from-pink-50 via-purple-50 to-orange-50 relative">
            <div className="absolute inset-0">
              ...
              <div className="absolute -bottom-16 -left-16 w-64 h-64 bg-gradient-to-br from-purple-200/30 to-orange-300/30 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                  Get answers to common questions about our premium escort services and professional companions in Indore
                </p>
              </div>
              
              <div className="max-w-5xl mx-auto space-y-6">
                {faqs.map((faq, index) => (
                  <div key={index} className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-pink-200/50 overflow-hidden hover:shadow-3xl transition-all duration-300">
                    <button
                      onClick={() => toggleFaq(index)}
                      className="w-full px-10 py-8 text-left flex justify-between items-center hover:bg-gradient-to-r hover:from-pink-50/70 hover:to-orange-50/70 transition-all duration-300 focus:outline-none group"
                    >
                      <span className="font-bold text-gray-800 text-xl pr-4 group-hover:text-pink-700">{faq.question}</span>
                      <span className={`text-3xl font-bold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent transition-transform duration-300 ${openFaq === index ? 'rotate-180' : ''}`}>
                        ▼
                      </span>
                    </button>
                    {openFaq === index && (
                      <div className="px-10 pb-8 border-t-2 border-gradient-to-r from-pink-200 to-orange-200 bg-gradient-to-r from-pink-50/50 to-orange-50/50">
                        <div className="pt-8">
              ...
              <div className="text-center mt-16">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 max-w-3xl mx-auto shadow-2xl border-2 border-pink-200/50">
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Still have questions?</h3>
                  <p className="text-gray-600 mb-6">Contact us directly for personalized assistance</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a 
                      href="tel:+919372662471"
                      className="bg-gradient-to-r from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 text-white px-8 py-4 rounded-full font-bold transition-all duration-300 transform hover:scale-105 shadow-xl"
                    >
                      📞 Call Now
                    </a>
                    <a 
                      href="https://wa.me/919372662471"
                      className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-8 py-4 rounded-full font-bold transition-all duration-300 transform hover:scale-105 shadow-xl"
                    >
                      💬 WhatsApp
                    </a>
                  </div>
