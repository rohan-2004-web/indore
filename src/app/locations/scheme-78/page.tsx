  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-200/60 via-orange-100/50 to-pink-300/60">
        ...
        {/* Complete Scheme 78 Services Catalogue */}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed">
                Discover our extensive range of premium escort services in Scheme 78. Each service is carefully curated to meet the highest standards of elegance and sophistication.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4 text-sm leading-relaxed">
                    Ultimate luxury companions for sophisticated gentlemen in Scheme 78
                  </p>
                  <div className="flex items-center justify-between">
                    <a 
              ...
              <div className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                ...
                <div className="p-6">
                  <p className="text-gray-600 mb-4 text-sm leading-relaxed">
                    Professional call girls available 24/7 in Scheme 78 area
                  </p>
                  <div className="flex items-center justify-between">
                    <a 
