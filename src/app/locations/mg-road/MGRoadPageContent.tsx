...
export default function MGRoadPageContent() {
  ...
  const services = [
    {
      ...
      description: "Experience celebrity-level companions on MG Road with exceptional elegance",
    ...
    },
    {
      ...
      description: "Our most exclusive VIP escorts on MG Road offering ultimate luxury",
    ...
    },
    {
      ...
      description: "Premium models on MG Road with unmatched sophistication",
    ...
    },
    {
      ...
      description: "Beautiful young companions on MG Road with vibrant energy",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "MG Road is Indore's prime commercial hub with business centers, shopping areas, and excellent connectivity making it perfect for professional escort services."
    },
    {
