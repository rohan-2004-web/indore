        ...
        <section className="py-16 px-4 bg-gradient-to-br from-pink-50 to-blue-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Our Premium Services in Treasure Island</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">Experience the finest escort services in Treasure Island with our professional companions</p>
            </div>
