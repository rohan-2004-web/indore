          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-pink-600 via-orange-500 to-purple-600 bg-clip-text text-transparent">
                🌟 Complete AB Road Services Catalogue 🌟
              </h2>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Discover our extensive range of premium escort services in AB Road. Each service is carefully curated to meet the highest standards of elegance and sophistication.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  image: "/images/services/VIP Escorts.jpg",
                  description: "Ultimate luxury companions for sophisticated gentlemen in AB Road",
                ...
                },
                {
                  ...
                  image: "/images/services/College Girls.webp",
                  description: "Professional call girls available 24/7 in AB Road area",
