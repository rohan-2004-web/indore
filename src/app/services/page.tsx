      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-200/60 via-orange-100/50 to-pink-300/60">
        ...
        <section className="py-20 relative">
          ...
          <div className="w-full px-4 relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-base md:text-2xl lg:text-xl font-bold bg-gradient-to-r from-pink-600 via-orange-500 to-pink-700 bg-clip-text text-transparent mb-4">
            ...
            <div className="w-full space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="group bg-gradient-to-br from-pink-100 to-pink-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border-pink-300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-pink-800 mb-2">Vijay Nagar</h3>
                    <p className="text-pink-600 font-semibold text-sm mb-2">Central Business District</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Premium business district with luxury hotels, shopping centers and corporate offices. Elite escort services available 24/7.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-blue-100 to-blue-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border-blue-300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-blue-800 mb-2">Saket</h3>
                    <p className="text-blue-600 font-semibold text-sm mb-2">Upscale Residential Hub</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Prestigious residential area with modern amenities and gated communities. Discrete home visit services available.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-orange-100 to-orange-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">💻</div>
                    <h3 className="text-xl font-bold  mb-2">Scheme 78</h3>
                    <p className="text-orange-600 font-semibold text-sm mb-2">IT Corporate Sector</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Technology hub with corporate offices, business hotels and modern infrastructure. Professional companions available.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-purple-100 to-purple-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🛍️</div>
                    <h3 className="text-xl font-bold  mb-2">AB Road</h3>
                    <p className="text-purple-600 font-semibold text-sm mb-2">Commercial Zone</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Main commercial area with luxury shopping, dining and premium hotels. Elite companions for business meetings.</p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="group bg-gradient-to-br from-green-100 to-green-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🌆</div>
                    <h3 className="text-xl font-bold  mb-2">Palasia</h3>
                    <p className="text-green-600 font-semibold text-sm mb-2">City Center</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Heart of Indore with premium facilities, accessibility and upscale venues. Professional escort services 24/7.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-teal-100 to-teal-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🏛️</div>
                    <h3 className="text-xl font-bold  mb-2">Bhawar Kuan</h3>
                    <p className="text-teal-600 font-semibold text-sm mb-2">Premium District</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Prestigious business and residential area with luxury amenities and high-end establishments.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-indigo-100 to-indigo-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🛣️</div>
                    ...
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Well-connected area with easy access to all parts of the city and premium establishments.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-red-100 to-red-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🏥</div>
                    <h3 className="text-xl font-bold  mb-2">Bombay Hospital</h3>
                    <p className="text-red-600 font-semibold text-sm mb-2">Medical District</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Healthcare hub with premium medical facilities and upscale accommodations nearby.</p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="group bg-gradient-to-br from-emerald-100 to-emerald-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🏛️</div>
                    <h3 className="text-xl font-bold  mb-2">MG Road</h3>
                    <p className="text-emerald-600 font-semibold text-sm mb-2">Heritage Area</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Historic area with cultural significance, premium hotels and upscale amenities.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-rose-100 to-rose-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">✈️</div>
                    <h3 className="text-xl font-bold  mb-2">Airport Road</h3>
                    <p className="text-rose-600 font-semibold text-sm mb-2">Aviation Zone</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Airport vicinity with luxury hotels, business centers and premium travel services.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-violet-100 to-violet-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🎯</div>
                    <h3 className="text-xl font-bold  mb-2">Treasure Island</h3>
                    <p className="text-violet-600 font-semibold text-sm mb-2">Entertainment Hub</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Entertainment and recreation center with modern facilities and premium venues.</p>
                  </div>
                ...
                <div className="group bg-gradient-to-br from-amber-100 to-amber-200 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 p-4 border border--300/60 transform hover:-translate-y-2 min-h-[280px] flex flex-col justify-between">
                  <div className="text-center">
                    <div className="text-4xl mb-2">🏰</div>
                    <h3 className="text-xl font-bold  mb-2">Rajwada</h3>
                    <p className="text-amber-600 font-semibold text-sm mb-2">Heritage Palace</p>
                    <p className="text-gray-700 text-xs mb-2 leading-relaxed">Historic royal palace area with cultural heritage and premium hospitality services.</p>
                  </div>
          ...
          <div className="w-full px-4">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                {/* Service Areas */}
                <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-lg p-8 border border-orange-100/50">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-orange-600 to-pink-600 bg-clip-text text-transparent mb-6">
                ...
                {/* Premium Features */}
                <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-lg p-8 border border-pink-100/50">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent mb-6">
                    ⭐ Premium Features
                  </h3>
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-lg p-8 border border-orange-100/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-800 mb-2">Contact Us</h4>
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-800 mb-2">Select Companion</h4>
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-800 mb-2">Enjoy Service</h4>
          ...
          <div className="w-full px-4">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* FAQ 1 */}
                <div className="bg-gradient-to-br from-pink-100 to-pink-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-pink-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(1)}
                ...
                {/* FAQ 2 */}
                <div className="bg-gradient-to-br from-orange-100 to-orange-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-orange-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(2)}
                ...
                {/* FAQ 3 */}
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-purple-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(3)}
                ...
                {/* FAQ 4 */}
                <div className="bg-gradient-to-br from-blue-100 to-blue-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-blue-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(4)}
                ...
                {/* FAQ 5 */}
                <div className="bg-gradient-to-br from-green-100 to-green-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-green-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(5)}
                ...
                {/* FAQ 6 */}
                <div className="bg-gradient-to-br from-red-100 to-red-200 backdrop-blur-md rounded-3xl shadow-lg border-2 border-red-300/60 overflow-hidden hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                  <button
                    onClick={() => toggleFaq(6)}
          ...
          <div className="w-full px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-pink-100 transform hover:-translate-y-3 transition-all duration-300">
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-purple-100 transform hover:-translate-y-3 transition-all duration-300">
                  <div className="text-6xl mb-4">🏆</div>
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-blue-100 transform hover:-translate-y-3 transition-all duration-300">
                  <div className="text-6xl mb-4">💎</div>
                ...
                <div className="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-lg border border-orange-100 transform hover:-translate-y-3 transition-all duration-300">
                  <div className="text-6xl mb-4">🌟</div>
              ...
              <div className="bg-gradient-to-r from-pink-500 via-purple-600 to-blue-500 rounded-3xl p-8 text-white">
                <h3 className="text-xl font-bold mb-4">🎖️ Join Our Premium Family 🎖️</h3>
